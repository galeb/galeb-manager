...
public class CommonJpaFilters {
    ...
    public static final String SAME_ACCOUNT_FILTER =
            "a.name = ?#{ authentication?.name }";

    public static final String HAS_ROLE_ADMIN_FILTER =
            "1 = ?#{ hasRole('ROLE_ADMIN') ? 1 : 0 }";

    public static final String SECURITY_FILTER =
            "(" + HAS_ROLE_ADMIN_FILTER + " OR " + SAME_ACCOUNT_FILTER + ")";
    ...
    public static final String QUERY_PROJECT_TO_ACCOUNT =
            "INNER JOIN e.project.teams t " +
            "LEFT JOIN t.accounts a ";

    private CommonJpaFilters() {
        //
    }
}
