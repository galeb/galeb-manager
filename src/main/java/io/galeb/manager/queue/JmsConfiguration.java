...
public class JmsConfiguration {
    ...
    public static class EfemeralJmsTemplate extends JmsTemplate {
        public EfemeralJmsTemplate(ConnectionFactory connectionFactory) {
            super(connectionFactory);
            setExplicitQosEnabled(true);
            setDeliveryPersistent(false);
            setReceiveTimeout(RECEIVE_TIMEOUT_NO_WAIT);
            setTimeToLive(EFEMERAL_JMS_TIMEOUT);
        }
    }
